<h1 align="center">Cardápio Web - Elite Burguer</h1>

<img width="1538" height="537" alt="banner-elite-burguer" src="https://github.com/user-attachments/assets/ee4d06ca-fcf3-4de7-b8fc-c0854c6e23a9" />
...
<ul>
  <li>
    ...
    Exibição das principais categorias de produtos disponíveis no cardápio.<br><br>
  </li>
  <li>
    <strong>Listagem de Produtos</strong><br>
    Cards contendo:
    <ul>
      ...
      <li>Descrição</li>
      <li>Preço</li>
      <li>Botão para adicionar ao pedido</li><br>
    </ul>
  </li>
  <li>
    <strong>Seção de Pedidos (Carrinho)</strong><br>
    Área onde o usuário poderá:
    <ul>
      <li>Visualizar os produtos adicionados</li>
      <li>Conferir o valor total da compra</li>
      <li>Finalizar o pedido</li><br>
    </ul>
  </li>
  <li>
    <strong>Contato</strong><br>
    Links diretos para atendimento via:
    <ul>
      <li>WhatsApp</li>
      <li>Instagram</li>
    </ul>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/joãovictormarcondes)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:joaovictormarcondes28@gmail.com)
